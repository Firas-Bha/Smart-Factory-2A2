...
void gestion_stock::on_pushButton_modifier1_clicked()
{
    int  id_Produit=ui->lineEdit_ID->text().toInt();
    QString nom_Produit=ui->lineEdit_NomProduit->text();
    int  prix_Produit=ui->lineEdit_prix->text().toInt();
...
void gestion_stock::on_pushButton_AfficherStock_clicked()
{
    ui->tableView_AffichageStock->setModel(tempStock.afficherStock());
}

void gestion_stock::on_pushButton_AjouterStock_clicked()
{
...
void gestion_stock::on_pushButton_5_clicked()
{
    int  id_stock=ui->lineEdit_idStock->text().toInt();
...
void gestion_stock::on_pushButton_7_clicked()
{
...
void gestion_stock::on_pushButton_ProduitTri_clicked()
{
...
void gestion_stock::on_pushButton_Supprimer1_clicked()
{
...
void gestion_stock::on_pushButton_8_clicked()
{
    sound->play();
        QSqlDatabase db;
...
void gestion_stock::on_pushButton_10_clicked()
{
...
void gestion_stock::on_pushButton_12_clicked()
{
...
void gestion_stock::on_pushButton_11_clicked()
{
    sound->play();
        QSqlDatabase db;
